package in.srain.cube.views.wt.indicator;
...
public class PtrIndicator {
    ...
    protected int mOffsetToGoDown = 0;
    ...
    public void setOffsetToGoDown(int offset) {
        mOffsetToGoDown = offset;
    }

    public int getOffsetToGoDown() {
        return mOffsetToGoDown;
    }
