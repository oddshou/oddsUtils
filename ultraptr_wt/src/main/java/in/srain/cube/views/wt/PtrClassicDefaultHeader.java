...
public class PtrClassicDefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    protected void initViews(AttributeSet attrs) {
        TypedArray arr = getContext().obtainStyledAttributes(attrs, R.styleable.WTPtrClassicHeader, 0, 0);
        if (arr != null) {
            mRotateAniTime = arr.getInt(R.styleable.WTPtrClassicHeader_ptr_rotate_ani_time, mRotateAniTime);
        }
        buildAnimation();
