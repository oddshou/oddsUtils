...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
    ...
    public PullToRefreshAdapterViewBase(Context context, AttributeSet attrs) {
        ...
        if (mRefreshableView instanceof MListView) {
            this.mListView = (MListView) mRefreshableView;
        }
    }
    ...
    public void setOnScrollYChanged(MListView.OnScrollYChanged mOnScrollYChanged) {
        if (mListView!=null){
            mListView.setOnScrollYChanged(mOnScrollYChanged);
        }
    }
    ...
    /**
     *
     * @param onScrollYChanged
     */
    private MListView.OnScrollYChanged mOnScrollYChanged;
...
//    public void setOnScrollYChanged(MListView.OnScrollYChanged onScrollYChanged) {
